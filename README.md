...
This template was not made *entirely* from scratch. I'd like to give special thanks to [wandgibaut](https://github.com/wandgibaut/wandgibaut.github.io), [Jekyll Now](https://github.com/barryclark/jekyll-now) and [Bootstrap Clean Blog](https://github.com/IronSummitMedia/startbootstrap-clean-blog).
